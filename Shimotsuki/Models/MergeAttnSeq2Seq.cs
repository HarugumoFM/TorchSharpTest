...
{
    public class MergeAttnSeq2Seq : Module
    {

        private Encoder encoder;
        private Encoder Reverse;
        private Linear merge;
        ...
        int hiddenSize;
        public Lang Lang;
        public MergeAttnSeq2Seq(int inputSize, int hiddenSize) : base("seq2seq")
        {
            Lang = new Lang();
            ...
            this.merge = Linear(hiddenSize * 2, hiddenSize);
            RegisterComponents();
        }
        ...
        public string evaluate(Tensor input, int maxLength)
        {
            ...
            for (int i = 0; i < inputLength; i++)
            {
                ...
                encoderOutputs[i] = merge.forward(concat(new List<Tensor>() { output, reverseOutput },2)[0, 0]);
            }
